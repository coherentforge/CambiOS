...
| `MAX_ENDPOINTS` | 32 | [src/ipc/mod.rs:22](src/ipc/mod.rs#L22) | Matches `MAX_PROCESSES`. Sharded IPC has one shard per endpoint; static array. | When `MAX_PROCESSES` grows, this grows with it. They're a pair. |

...
# Commit-msg hook (H1, 2026-04-23): Claude-authored commits must include a
# `Staged files:` block matching `git diff --cached --name-only`. Runs
# automatically when installed via `make install-hooks`; script is
# tools/check-claude-staged-files.py.
